...
class AutonomyTests(unittest.TestCase):
    ...
    def test_current_version_is_consistent_across_runtime_and_docs(self):
        ...
        self.assertIn('Huidige release: **28.00**.', readme)
        self.assertIn('Volgende release: **29.00**.', readme)
        ci = (root.parent / '.github' / 'workflows' / 'ci.yml').read_text(encoding='utf-8')
        self.assertEqual(ci.count("app.APP_VERSION == '28.00'"), 2)
        self.assertIn('BUILD_VERSION=28.00', ci)
