...
class AutonomyTests(unittest.TestCase):
    ...
    def test_current_version_is_consistent_across_runtime_and_docs(self):
        ...
        self.assertIn('Huidige release: **26.00**.', readme)
        self.assertIn('Volgende release: **27.00**.', readme)
        ci = (root.parent / '.github' / 'workflows' / 'ci.yml').read_text(encoding='utf-8')
        self.assertEqual(ci.count("app.APP_VERSION == '26.00'"), 2)
        self.assertIn('BUILD_VERSION=26.00', ci)
